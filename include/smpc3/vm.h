...
typedef struct SmpVM {
    ...
    /* Профиль: секунды на каждую инструкцию модуля, накопительно по
     * прогонам. Массив на mod->n_code элементов даёт хозяин; NULL — ничего
     * не меряется, и цена этого — одна проверка на инструкцию. */
    double   *prof;
    double    prof_last;
    bool      prof_started;
